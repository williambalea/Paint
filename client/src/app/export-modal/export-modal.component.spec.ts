...
describe('ExportModalComponent', () => {
  ...
  beforeEach(() => {
    ...
    viewChildService.canvas = new ElementRef(document.createElement('canvas'));
  ...
  it('should download with right params', () => {
    // viewChildService.htmlCanvas = new ElementRef(document.createElement('canvas'));
    component.downloadLink = new ElementRef(document.createElement('canvas'));
    component.downloadImage('test');
